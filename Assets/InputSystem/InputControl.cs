...
public partial class @InputControl : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Glide"",
                    ""type"": ""Button"",
                    ""id"": ""16c98019-4c0d-4daf-b4fa-b50c0fc15b2b"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6a491b86-cb6f-46ce-a02b-cb808707f48b"",
    ...
    ""controlSchemes"": []
        ...
        m_GamePlayer_Glide = m_GamePlayer.FindAction("Glide", throwIfNotFound: true);
        // UI
    ...
    private readonly InputAction m_GamePlayer_Glide;
    public struct GamePlayerActions
    {
        ...
        public InputAction @Glide => m_Wrapper.m_GamePlayer_Glide;
        ...
        public void SetCallbacks(IGamePlayerActions instance)
        {
            if (m_Wrapper.m_GamePlayerActionsCallbackInterface != null)
            {
                ...
                @Glide.started -= m_Wrapper.m_GamePlayerActionsCallbackInterface.OnGlide;
                @Glide.performed -= m_Wrapper.m_GamePlayerActionsCallbackInterface.OnGlide;
                @Glide.canceled -= m_Wrapper.m_GamePlayerActionsCallbackInterface.OnGlide;
            }
